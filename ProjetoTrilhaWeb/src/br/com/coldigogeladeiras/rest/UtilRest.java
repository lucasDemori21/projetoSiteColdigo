...
public class UtilRest {
	/*
	 * Abaixo o método responsável por enviar a resposta ao cliente sobre a
	 * transação realiza (inclusão, consulta, edição ou exclusão) caso ela seja
	 * realizada com sucesso. Repare que o método em questão aguarda que seja
	 * repassado um conteúdo que será referenciado por um objeto chamado result
	 */
	...
	/*
	 * Abaixo o método responsável por enviar a resposta ao cliente sobre A
	 * transação realizada, inclusão, consulta, edição ou exclusão.ao erro. Repare
	 * que o método em questão aguarda que seja repassado um conteúdo que será
	 * referenciado pelo por um objeto chamado rb
	 */
